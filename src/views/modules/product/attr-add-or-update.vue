  ...
  >
    <el-form :model="dataForm" :rules="dataRule" ref="dataForm" label-width="120px">
      ...
      <el-form-item label="属性类型" prop="attrType">
        <el-select v-model="dataForm.attrType" disabled="true" placeholder="请选择">
      ...
      <el-form-item label="所属分组" prop="attrGroupId" v-if="type == 1">
        <el-select ref="groupSelect" clearable="true" filterable="true"  v-model="dataForm.attrGroupId" placeholder="请选择">
          <el-option
