  ...
  <nav class="site-navbar" :class="'site-navbar--' + navbarLayoutType">
    <div class="site-navbar__header">
      <h1 class="site-navbar__brand" @click="$router.push({ name: 'home' })">
        <a class="site-navbar__brand-lg" href="javascript:;">东哥哥商城后台管理平台</a>
        <a class="site-navbar__brand-mini" href="javascript:;">东哥哥</a>
      </h1>
    </div>
...
<!--
        ...
        <el-submenu index="3">
          ...
          <el-menu-item index="2-1"><a href="https://github.com/renrenio/mall-vue" target="_blank">前端</a></el-menu-item>
